...
class CTrainTicket
{
        friend class CQuadraticProbing;
        private:
                int seatNo;
                string name;
                int age;
...
CQuadraticProbing::CQuadraticProbing(int t)
{
        tableSize = t;
        size = 0;
        table = new CTrainTicket[tableSize];
}
CQuadraticProbing::~CQuadraticProbing()
{
        tableSize = 0;
        size = 0;
        delete[] table;
...
int CQuadraticProbing::insert(CTrainTicket s)
{
        if(isFull()) { return -2;}
        int i,bucketId;
        int K = s.getseatNo();
        ...
        {
                bucketId = ((K%tableSize) + i*i)%tableSize; //HashFn.
...
int CQuadraticProbing::deleteTicket(int K)//where K is seatNo
{
        if(isEmpty()) { return -2;}
        int i,bucketId;
        for(i=0;i<tableSize;i++)
...
int CQuadraticProbing::search(int K)//where K is seatNo
{
        if(isEmpty()) { return -2;}
        int i,bucketId;
        for(i=0;i<tableSize;i++)
...
void CQuadraticProbing::display()
{
        cout<<"|=======================================================|\n";
        cout<<"| Bucket ID \t| SeatNo. \t| Name \t\t| Age\t|\n";
        cout<<"|=======================================================|\n";
